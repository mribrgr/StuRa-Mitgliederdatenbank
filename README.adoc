...
image:https://github.com/mribrgr/StuRa-Mitgliederdatenbank/workflows/flake8/badge.svg?branch=develop["flake8", link="https://github.com/mribrgr/StuRa-Mitgliederdatenbank/workflows/flake8/badge"]
