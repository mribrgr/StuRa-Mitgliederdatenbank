...
* link:https://wiki.stura.htw-dresden.de/index.php/Diskussion:Mitgliederdatenbank[Diskussion Mitgliederdatenbank] - Enthält einen möglichen, bereits vom StuRa ausgearbeiteten Ansatz zur Strukturierung der Date
