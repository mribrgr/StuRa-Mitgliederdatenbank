...
urlpatterns = [
    ...
    path('ajax/funktionen-laden', views.funktionen_laden, name='funktionen_laden'),
    path('ajax/funktionen-html-laden', views.funktionen_html_laden, name='funktionen_html_laden'),
    path('ajax/funktion-loeschen', views.funktion_loeschen, name='funktionen_loeschen'),
