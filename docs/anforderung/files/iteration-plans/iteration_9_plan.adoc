...
|Meilenstein
|Datum
|Beginn der Iteration |25.05.2020
|Fertigstellen der Aufgaben|-
|Ende der Iteration	|07.06.2020
|===
...
| Iterationsplan 10 erstellen | hoch | 3 | erledigt | x | mribrgr | 3 | 0

// alte Aufgaben

// neue Aufgaben
// thrs79136, yoshinonxkun, mribrgr, benjamin-hempel, redifity
| Pagination hinzufügen | mittel | 5 | erledigt | x | benjamin-hempel | 8 | 0
| Diagramme überarbeiten | mittel | 3 | erledigt | x | redifity | 5 | 0
| Bug fixes | mittel | 5 | erledigt | x | thrs79136 | 8 | 0
| Unit Tests schreiben für Mitglieder und Ämter Modul | mittel | 3 | erledigt | x | yoshinonxkun | 5 | 0
...
|Internetproblem | in Arbeit | Theresa hat durch Umzug kein Internet
|===
...
[%header, cols="1,3"]
|===
|Assessment Ziel	| Iteration 9 fertigstellen
|Assessment Datum | 07.06.2020
|Teilnehmer	| alle
|Projektstatus	| grün
|===
