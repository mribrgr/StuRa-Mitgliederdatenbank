...
|Meilenstein
|Datum
|Beginn der Iteration |27.04.2020
|Fertigstellen der Aufgaben|-
|Ende der Iteration	|10.05.2020
|===
...
| Iterationsplan 8 erstellen | hoch | 3 | erledigt | x | mribrgr | 3 | 0

// alte Aufgaben

// neue Aufgaben
// thrs79136, yoshinonxkun, mribrgr, benjamin-hempel, redifity
| Suchfunktion hinzufügen | mittel | 5 | erledigt | x | benjamin-hempel | 8 | 0
| Ämteransicht implementiert | mittel | 5 | erledigt | x | redifity | 8 | 0
| Mitgliederverwaltung erweitern, Bugs lösen | mittel | 5 | erledigt | x | thrs79136 | 8 | 0
| Erste Tests schreiben | mittel | 3 | erledigt | x | yoshinonxkun | 5 | 0
...
[%header, cols="1,3"]
|===
|Assessment Ziel	| Iteration 7 fertigstellen
