...
// alte Aufgaben
| Legislaturen auflisten | mittel | 2 | ausstehend | link:../glossary.adoc[Glossar], link:https://github.com/mribrgr/StuRa-Mitgliederdatenbank/issues/24[Issue #24] | Jill3, Helene3e, Unterstützung von thrs79136 | 0.5 | 2
