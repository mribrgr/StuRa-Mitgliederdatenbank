...
|Meilenstein
|Datum
|Beginn der Iteration |11.05.2020
|Fertigstellen der Aufgaben|-
|Ende der Iteration	|24.05.2020
|===
...
| Iterationsplan 9 erstellen | hoch | 3 | erledigt | x | mribrgr | 3 | 0

// alte Aufgaben

// neue Aufgaben
// thrs79136, yoshinonxkun, mribrgr, benjamin-hempel, redifity
| Historie überarbeiten | mittel | 5 | erledigt | x | benjamin-hempel | 8 | 0
| Architekturnotebook überarbeiten | mittel | 5 | erledigt | x | redifity | 8 | 0
| Mitgliederverwaltung erneut überarbeiten | mittel | 5 | erledigt | x | thrs79136 | 8 | 0
| Erste Github Actions schreiben | mittel | 3 | erledigt | x | yoshinonxkun | 5 | 0
| Automatisierte Tests schreiben | mittel | 5 | erledigt | x | yoshinonxkun | 8 | 0
...
[%header, cols="1,3"]
|===
|Assessment Ziel	| Iteration 8 fertigstellen
|Assessment Datum | 24.05.2020
|Teilnehmer	| alle
|Projektstatus	| grün
|===
