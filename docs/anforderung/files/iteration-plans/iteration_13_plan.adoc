...
|Meilenstein
|Datum
|Beginn der Iteration |20.07.2020
|Fertigstellen der Aufgaben|-
|Ende der Iteration	|02.08.2020
|===
...
| Iterationsplan 14 erstellen | hoch | 3 | erledigt | x | mribrgr | 3 | 0

// alte Aufgaben

// neue Aufgaben
// thrs79136, yoshinonxkun, mribrgr, benjamin-hempel, redifity
| Grammar Überarbeitung | mittel | 2 | erledigt | x | benjamin-hempel | 3 | 0
| Admin Panel Überarbeitung | hoch | 2 | erledigt | x | benjamin-hempel | 3 | 0
| Diagramme überarbeiten | mittel | 5 | erledigt | x | redifity | 8 | 0
| Mitgliederverwaltung | mittel | 5 | erledigt | x | thrs79136 | 8 | 0
| Sphinx weiterentwickeln | mittel | 3 | erledigt | x | yoshinonxkun | 5 | 0
...
[%header, cols="1,3"]
|===
|Assessment Ziel	| Iteration 13 fertigstellen
|Assessment Datum | 02.08.2020
|Teilnehmer	| alle
|Projektstatus	| grün
|===
