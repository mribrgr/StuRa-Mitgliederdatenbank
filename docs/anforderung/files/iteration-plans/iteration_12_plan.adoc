...
|Meilenstein
|Datum
|Beginn der Iteration |06.07.2020
|Fertigstellen der Aufgaben|-
|Ende der Iteration	|19.07.2020
|===
...
| Iterationsplan 13 erstellen | hoch | 3 | erledigt | x | mribrgr | 3 | 0

// alte Aufgaben

// neue Aufgaben
// thrs79136, yoshinonxkun, mribrgr, benjamin-hempel, redifity
| Mobile Unterstützung ergänzen | mittel | 5 | erledigt | x | benjamin-hempel | 8 | 0
| Diagramme überarbeiten | mittel | 3 | erledigt | x | redifity | 5 | 0
| Löschen Pop Up | mittel | 5 | erledigt | x | thrs79136 | 8 | 0
| Testdoku erweitern | mittel | 3 | erledigt | x | yoshinonxkun | 5 | 0
...
[%header, cols="1,3"]
|===
|Assessment Ziel	| Iteration 12 fertigstellen
|Assessment Datum | 19.07.2020
|Teilnehmer	| alle
|Projektstatus	| grün
|===
