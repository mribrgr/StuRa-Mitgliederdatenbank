...
|Meilenstein
|Datum
|Beginn der Iteration |08.06.2020
|Fertigstellen der Aufgaben|-
|Ende der Iteration	|21.06.2020
|===
...
| Iterationsplan 11 erstellen | hoch | 3 | erledigt | x | mribrgr | 3 | 0

// alte Aufgaben

// neue Aufgaben
// thrs79136, yoshinonxkun, mribrgr, benjamin-hempel, redifity
| Historie erneut überarbeiten | mittel | 5 | erledigt | x | benjamin-hempel | 8 | 0
| Bugfix Ämter | mittel | 5 | erledigt | x | redifity | 8 | 0
| Mitgliederverwaltung letzte Bugs | mittel | 5 | erledigt | x | thrs79136 | 8 | 0
| Pagination + Ämter Tests schreiben | mittel | 3 | erledigt | x | yoshinonxkun | 5 | 0
| Raspberry Umgebung bauen | mittel | 5 | erledigt | x | yoshinonxkun | 8 | 0
...
[%header, cols="1,3"]
|===
|Assessment Ziel	| Iteration 10 fertigstellen
|Assessment Datum | 21.06.2020
|Teilnehmer	| alle
|Projektstatus	| grün
|===
