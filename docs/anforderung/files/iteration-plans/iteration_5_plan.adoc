...
|Meilenstein
|Datum
|Beginn der Iteration |30.03.2020
|Fertigstellen der Aufgaben|-
|Ende der Iteration	|12.04.2020
|===
...
* Testeinarbeitung
* Erstellung Mitgliederanzeige und Permission System
...
// neue Aufgaben
// thrs79136, yoshinonxkun, mribrgr, benjamin-hempel
| In Selenium einarbeiten, erste Tests erstellen | mittel | 5 | erledigt | x | yoshinonxkun | 8 | 0
| Erstellung Mitgliederanzeige | hoch | 5 | erledigt | x | thrs79136 | 8 | 0
| Erstellung Permission System | hoch | 5 | erledigt | x | benjamin-hempel | 8 | 0
| Risks.csv überarbeiten | hoch | 3 | erledigt | x | mribrgr | 3 | 0
| Eigene Einarbeitung | mittel | 5 | erledigt | x | redifity | 8 | 0
...
[%header, cols="1,3"]
|===
|Assessment Ziel	| Iteration 5 fertigstellen
