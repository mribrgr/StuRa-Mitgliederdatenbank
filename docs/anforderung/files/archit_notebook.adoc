...
* Sicherung und Wiederherstellung von Systemzuständen gewährleisten (zeitlich automatisiert)
...
. Objektorientierte Programmierung -> Komponentenarchitektur
...
* Schichtenrangfolge: Python -> Django -> SQLite -> LXC Container -> Webserver
...
include::usecases/nutzer_verwalten.adoc[Arbeitsleitfaden abarbeiten]
