...
===	Kurzbeschreibung
Als Mitglied der internen Verwaltung des StuRas +
möchte ich Ämter hinzufügen, bearbeiten und entfernen können.
...
==== Amt bearbeiten
. Der Use Case beginnt, wenn der Nutzer dem System mitteilt, dass er ein Amt beawrbeiten möchte
. Eingabe der Daten
. Bestätigung
. Der Use Case ist abgeschlossen.
